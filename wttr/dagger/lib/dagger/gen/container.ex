...
defmodule Dagger.Container do
  ...
  @spec terminal(t(), [{:cmd, [String.t()]}]) :: Dagger.Terminal.t()
  def terminal(%__MODULE__{} = container, optional_args \\ []) do
    selection =
      container.selection |> select("terminal") |> maybe_put_arg("cmd", optional_args[:cmd])
  ...
  @spec with_default_terminal_cmd(t(), [String.t()]) :: Dagger.Container.t()
  def with_default_terminal_cmd(%__MODULE__{} = container, args) do
    selection =
      container.selection |> select("withDefaultTerminalCmd") |> put_arg("args", args)
